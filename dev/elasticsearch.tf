module "es" {
  ...
  log_publishing_options = {
    index_slow_logs = {
      enabled                          = true
      cloudwatch_log_group_name        = "/aws/OpenSearchService/domains/ST-search-dev/index-logs"
      log_publishing_options_retention = 90
    }
    search_slow_logs = {
      enabled                   = true
      cloudwatch_log_group_name = "/aws/OpenSearchService/domains/ST-search-dev/index-logs/index_slow_logs"
    }
    es_application_logs = {
      enabled                   = true
      cloudwatch_log_group_name = "/aws/OpenSearchService/domains/ST-search-dev/application-logs"
    }
    audit_logs = {
      enabled                   = false
  ...
  domain_endpoint_options = {
    ...
    #custom_endpoint                 = "ST-search-dev.wellops4500.com"
